...
Example:
    ...
    pca_result, variance, n_components, outputs, scaler = compute_pca(activations, layer=22)
...
def compute_pca(activation_list, layer: int | None, scaler=None, verbose: bool = True):
    ...
    Returns:
        Tuple of (pca_transformed, variance_explained, n_components, outputs, fitted_scaler)
    """
    # Select layer
